"""
This modules provies the packet used for communication between client
and server.
"""
...
class Packet(metaclass=abc.ABCMeta):
    ...
    async def from_stream(cls,
        ...
        The child class needs to implement this method for further
        reading as per its structure.
        """
...
class PacketRegistery:
    """
    Manages the packet versions and their respective handlers. Not all
    versions are allowed (see `version_allowed`).
